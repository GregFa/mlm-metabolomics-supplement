...
# ╔═╡ a4188e57-2652-49a9-b214-a7d543dad3db
...
begin 
	est = xcopd[idxCritical]
	lo = (xcopd.-εcopd)[idxCritical]
	up = (xcopd.+εcopd)[idxCritical]

	se = (up .− lo)./(2*1.96)
	tstats = est./se
	pvalues = exp.(−0.717.*tstats .− 0.416.*tstats.^(2))
end
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "2e9b494b0b9f6b1bf96c4c907a0019a28cd732c5"
