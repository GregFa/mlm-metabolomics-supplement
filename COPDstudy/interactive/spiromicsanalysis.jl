...
md"""
# SPIROMICS Analysis Using Matrix Linear Models  
---
...
begin
	...
	fileIndividuals = joinpath(@__DIR__,"..","data","processed","SPIROMICS",
								"SPIROMICS_ClinicalCovariates.csv");
...
md"""
The following table presents the demographics for the COPDGene cohort:
"""
...
if (@isdefined mX)
	if radio_X
		...
		md"The size of X is $(size(mX, 1)) x $(size(mX, 2))."
	end
end
end
...
# ╔═╡ fb46bfb6-b246-4af7-abc4-edabd8afe980
begin
...
begin
	if @isdefined TstatZsp
		...
		namesZsup = string.(permutedims(levelsSup[1:end]))
		confidenceplot(vec(permutedims(CoefZsp[idxCovarsup,:])), 
					vec(namesZsup),
...
# ╔═╡ ecb1ce4f-0f49-420a-bd5f-d4ae84f65da6
begin
...
# ╔═╡ 54f3e848-e60d-4ccd-a790-90c8bb55218b
begin
...
# ╔═╡ a4f29f56-9117-41ef-848e-496f1ea60f81
begin
...
# ╔═╡ 0ed66489-c555-43f0-9950-9a315aeda8c5
begin
